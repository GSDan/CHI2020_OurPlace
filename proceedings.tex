...
\title{We are the Greatest Showmen: Configuring Curriculum Frameworks for Project-Based Mobile Learning}
...
\begin{abstract}
Little research has been performed exploring how mobile-learning technologies could be used by students to produce interactive artefacts during project-based learning processes. Following a design-based research approach, we report on engagements spanning classroom and outdoor learning with teachers and students (ages 6-13) from three different UK schools and a summer school of Travelling Showchildren. Working within each given context's time constraints, we deployed a variety of configurations of a project-based mobile learning (PBML) curriculum framework designed to produce student-designed mobile-learning activities, and tested it using the open-source application OurPlace. We contribute insights gained from these studies, including how mobile technologies can harness students' existing desire for independence and how they can be configured to leverage the physical and social attributes of place and community as learning resources. We also argue for further exploration of the potential roles for mobile technologies within project-based learning, and contribute our PBML curriculum framework alongside suggestions for its re-configuration in response to given contextual constraints.
\end{abstract}
